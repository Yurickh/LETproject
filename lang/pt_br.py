...
EXCEPTION_INV_CRS_NM = "Nome de curso inválido"
EXCEPTION_INV_CRS_ID = "Id de curso inválida."
EXCEPTION_INV_CRS_ST = "Lista de estudantes inválida."
EXCEPTION_INV_CRS_MD = "Lista de módulos inválida."
