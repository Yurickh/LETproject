...
"""Error message for an invalid student registration number"""
EXCEPTION_INV_STU_BS = "Biografia de aluno inválida."
"""Error message for an invalid students bios."""
EXCEPTION_INV_STU_CP = "Campus de aluno inválido."
"""Error message for an invalid student campus"""
EXCEPTION_INV_STU_CO = "Campo curso de aluno inválido."
"""Error message for an invalid student course."""
EXCEPTION_INV_STU_AV = "Avatar de aluno inválido."
"""Error message for an invalid student avatar."""
EXCEPTION_INV_STU_SX = "Sexo de aluno inválido."
"""Error message for an invalid student sex."""
...
"""Error message for an invalid student grades format."""
EXCEPTION_INV_STU_IN = "Interesses do aluno em formato inválido."
"""Error message for the student interests written in an invalid format."""
...
"""Error message for an invalid course name."""
...
"""Error message for an invalid module name."""
EXCEPTION_INV_MD_ID = "Id do módulo inválido."
"""Error message for an invalid module Id."""
EXCEPTION_INV_MD_LT = "Tipo de lição inválido."
"""Error mesage for an invalid lesson type."""

EXCEPTION_INV_LS_NM = "Nome da lição inválido."
"""Error message for an invalid lesson name."""
EXCEPTION_INV_LS_ID = "Id da lição inválido."
"""Error message for an invalid lesson Id."""
EXCEPTION_INV_LS_LK = "Link da lição inválido."
"""Error message for an invalid lesson link."""
EXCEPTION_INV_LS_ST = "Tipo de exercício da lição inválido."
"""Error message for an invalid lesson exercise type."""
...
"""Error message for an invalid exercise format."""
EXCEPTION_INV_EX_IT = "Itens do exercício inválidos."
"""Error message for invalid exercise items."""
