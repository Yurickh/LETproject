...
O\+B\+S\+: As últimas versões do Ubuntu e Fedora já vêm com o python 2.\+7 e as últimas versões do R\+H\+E\+L e Cent\+O\+S já vêm com o python 2.\+6. \end{quote}
...
\begin{DoxyItemize}
\item Baixe \href{https://www.djangoproject.com/download/1.7.1/tarball/}{\tt Download Django-\/1.\+7.\+1.\+tar.\+gz}. Então extraia o arquivo, inicie o D\+O\+S shell (ctrl+\+E, cmd) com permissão de administrador e execute o comando no diretório cujo nome inicie com \char`\"{}\+Django-\/\char`\"{}\+: {\ttfamily \$ python setup.\+py install}
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item Baixe \href{https://www.djangoproject.com/download/1.7.1/tarball/}{\tt Download Django-\/1.\+7.\+1.\+tar.\+gz}. Então\+: {\ttfamily \$ tar xzvf Django-\/1.\+6.\+2.\+tar.\+gz} {\ttfamily \$ cd Django-\/1.\+6.\+2} {\ttfamily \$ sudo python setup.\+py install} 
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyEnumerate}