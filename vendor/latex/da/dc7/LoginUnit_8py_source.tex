...
00195 
\hypertarget{LoginUnit_8py_source_l00196}{}\hyperlink{classLogin_1_1LoginUnit_1_1BusLogin_a2301425767b811697ce559801b955a58}{00196}     \textcolor{keyword}{def }\hyperlink{classLogin_1_1LoginUnit_1_1BusLogin_a2301425767b811697ce559801b955a58}{validate}(self, username, password, database):
...
00200 
\hypertarget{LoginUnit_8py_source_l00201}{}\hyperlink{classLogin_1_1LoginUnit_1_1BusLogin_a23223ddd567bf874e6230efaf4912e98}{00201}     \textcolor{keyword}{def }\hyperlink{classLogin_1_1LoginUnit_1_1BusLogin_a23223ddd567bf874e6230efaf4912e98}{getLang}(self, username, database):
...
00228                 uid = database.objects.get(value=username, field=\textcolor{stringliteral}{'NAME'})
00229                 uid = uid.identity
00230                 upass = database.objects.get(identity=uid, field=\textcolor{stringliteral}{'PASSWORD'})
00231                 upass = upass.value
00232             \textcolor{keywordflow}{except} database.DoesNotExist:
00233                 \textcolor{keywordflow}{return} \textcolor{keyword}{False}
00234 
00235             if(database.\_\_name\_\_ == \textcolor{stringliteral}{"Student"} \textcolor{keywordflow}{or} 
00236                database.\_\_name\_\_ == \textcolor{stringliteral}{"Professor"}):
00237                 \textcolor{keywordflow}{try}:
00238                     ulang= database.objects.get(identity=uid, field=\textcolor{stringliteral}{'LANGUAGE'})
00239                     ulang= ulang.value
00240                 \textcolor{keywordflow}{except} database.DoesNotExist:
00241                     \textcolor{keywordflow}{return} \textcolor{keyword}{False}
00242             \textcolor{keywordflow}{else}:
00243                 ulang = settings.LANGUAGE\_CODE
00244 
