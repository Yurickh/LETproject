...
00083   * Baixe [Download Django-1.6.2.tar.gz](https:\textcolor{comment}{//www.djangoproject.com/download/1.6.2/tarball/). Então
       extraia o arquivo, inicie o DOS}
00084  shell com permiss� de administrador e execute o comando no diretório cujo nome inicie com "Django-":
    `$ python setup.py install`
...
00090   * "Manualmente":
00091     * Baixe [Download Django-1.6.2.tar.gz](https:\textcolor{comment}{//www.djangoproject.com/download/1.6.2/tarball/). Então:}
